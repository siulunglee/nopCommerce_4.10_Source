...
{
    /// <summary>
    /// Represents settings of the EShipper1 shipping plugin
    /// </summary>
    public class EShipper1Settings : ISettings
    {
        /// <summary>
        /// Gets or sets EShipper1 service URL
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets EShipper1 customer classification
        /// </summary>
        public EShipper1CustomerClassification CustomerClassification { get; set; }

        /// <summary>
        /// Gets or sets a pickup type
        /// </summary>
        public EShipper1PickupType PickupType { get; set; }

        /// <summary>
        /// Gets or sets packaging type
        /// </summary>
        public EShipper1PackagingType PackagingType { get; set; }
