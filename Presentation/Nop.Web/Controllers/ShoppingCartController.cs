...
namespace Nop.Web.Controllers
{
    public partial class ShoppingCartController : BasePublicController
    {
           ...
           DateTime? rentalEndDate, int quantity)
        {
            ...
            {
                //add to the cart if it is a newly added item
        ...
        //add product to cart using AJAX
        //currently we use this method on the product details pages / modified the original source by Henry
        [HttpPost]
            ...
            bool loadPicture, IFormCollection form)
        {
            ...
            var adminComment = product.AdminComment; // Beware that for coroplast sign, it is store with the price list and formulas
        ...
        public virtual IActionResult UploadFileProductAttribute(int attributeId)
        {
            ...
            Console.WriteLine("Filename before: " + fileName);

            fileName = fileName == "" || fileName == "blob" ? "file.jpg" : fileName;

            Console.WriteLine("Filename after: " + fileName);
