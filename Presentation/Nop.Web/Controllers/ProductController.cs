...
namespace Nop.Web.Controllers
{
    public partial class ProductController : BasePublicController
    {
        ...
        public virtual IActionResult ProductDetails(int productId, int updatecartitemid = 0, int reorder = 0)
        {
            ...
            if (_shoppingCartSettings.AllowCartItemEditing && updatecartitemid > 0 && reorder == 1)
            {
                ...
                updatecartitem.ReOrder = 1;
                //updatecartitem.Id = 0;

                Console.WriteLine("Reorder 1!");
                Console.WriteLine(updatecartitem.Quantity);
                Console.WriteLine(updatecartitem.Id);
                Console.WriteLine(updatecartitem.AttributesXml);
                Console.WriteLine(updatecartitem.ReOrder);
                Console.WriteLine("Reorder 1!");
            }
            else if (_shoppingCartSettings.AllowCartItemEditing && updatecartitemid > 0 && reorder == 0)
            {
                var cart = _workContext.CurrentCustomer.ShoppingCartItems
                    .LimitPerStore(_storeContext.CurrentStore.Id)
                    .ToList();
